...
# Instalar dependências básicas para repositórios e certificados (PRIMEIRO PASSO)
...
# Adicionar o repositório oficial do Dart e instalar o SDK (SEGUNDO PASSO SEPARADO)
# Garante que 'ca-certificates' está pronto antes de curl tentar usar SSL
